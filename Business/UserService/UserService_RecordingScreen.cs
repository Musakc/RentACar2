...
{
    public class UserService_RecordingScreen
    {
        //private readonly UserRepository_RecordingScreen _userRepository;

        //public UserService_RecordingScreen(UserRepository_RecordingScreen userRepository)
        //{
